<template>
  <div class="home">
  	<div v-if="edit==false" class="notEdit">
	    <div class="search-add">
	    	<div class="search">
	    		<input type="text" placeholder="搜索公告关键字找公告">
	    		<span></span>
	    	</div>
	    	<div class="add" @click="edit=true">
    		...
    		<ul>
    			<li v-for="(item,index) in homeNoticeList.notice_list">
    				...
    				<div class="listBody">
    					...
    					<div class="noticeCreator">{{item.creator}}&nbsp&nbsp&nbsp{{item.publish_date}}</div>
    ...
    <div v-if="edit==true" class="edit">
    	<div class="newNotice">首页&nbsp&nbsp>&nbsp&nbsp新公告</div>
